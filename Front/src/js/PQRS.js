...
async function registrarPQRS(){
    ...
    datos.tipo = select_request_type.options[select_request_type.selectedIndex].value; /*Obtener id de la opción destino*/
    datos.descripcion = document.getElementById('compose-textarea').value;
    datos.identificacionEvento = localStorage.verEvento;


    // const request = await fetch('http://localhost:8081/activate/event/PQRS', {
    //     method: 'POST',
    //     headers: getHeaders(),
    ...
    document.getElementById("request_responsable").innerHTML = "Su madre";
}